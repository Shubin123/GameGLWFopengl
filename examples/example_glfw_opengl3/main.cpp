    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        if (show_another_window)
        {
            ...
            if (mousetoggle) {
                ...
                glfwSetCursorPos(window, 100, 100); // min x and min y
                mouseaccx += .5 * (mousex - 100);
                mouseaccy += .5 * (mousey - 100);
                    cout << mouseaccx << endl;
            ...
            display(window, f_gui, playerz, playerx, playery, playerrotx, playerroty, playerrotz, mouseaccy, mouseaccx);
